...
class PlayerRenderHandler : public CefRenderHandler {
public:
    PlayerRenderHandler(class Player* player_) : player(player_) {}
...
private:
    Player* player;
    IMPLEMENT_REFCOUNTING(PlayerRenderHandler);
};

class PlayerBrowserClient : public CefClient {
public:
    PlayerBrowserClient(CefRefPtr<PlayerRenderHandler> render_handler_) : render_handler(render_handler_) {}
    virtual CefRefPtr<CefRenderHandler> GetRenderHandler() override { return render_handler; }

private:
    CefRefPtr<PlayerRenderHandler> render_handler;
